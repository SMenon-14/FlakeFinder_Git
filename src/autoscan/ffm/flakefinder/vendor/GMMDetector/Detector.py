...
class MaterialDetector:
    ...
    def detect_flakes(
        ...
        for layer_index, layer_mask in enumerate(semantic_masks):
            ...
            # Fill small holes / gaps so each flake forms one solid blob
            # instead of a speckled, jagged region.
            layer_mask = cv2.morphologyEx(layer_mask, cv2.MORPH_CLOSE, disk(7))
